<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否单双周课程" prop="singleDoubleWeek">
        <el-input
          v-model="queryParams.singleDoubleWeek"
          placeholder="请输入是否单双周课程"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="classscheduleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否单双周课程" align="center" prop="singleDoubleWeek" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="classscheduleRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="是否单双周课程" prop="singleDoubleWeek">
          <el-input v-model="form.singleDoubleWeek" placeholder="请输入是否单双周课程" />
        </el-form-item>
        <el-form-item label="班级id" prop="classId">
...
const { course_class } = proxy.useDict('course_class');
...
const data = reactive({
  ...
  rules: {
    singleDoubleWeek: [
      { required: true, message: "是否单双周课程不能为空", trigger: "blur" }
    ],
    classId: [
